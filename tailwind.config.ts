...
const config: Config = {
  // Graphite is a second dark-family theme: dark: variants apply to both.
  darkMode: ["variant", ["&:is(.dark, .dark *)", "&:is(.graphite, .graphite *)"]],
  content: [
    "./app/**/*.{ts,tsx}",
    "./components/**/*.{ts,tsx}",
    "./lib/**/*.{ts,tsx}",
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Reward color — leader, offers, the trophy. Keep scarce.
        gold: "hsl(var(--gold))",
      },
      borderRadius: {
        lg: "var(--radius)",
